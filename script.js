var number = 0;
var virus1 = "https://sajtasdasdas.000webhostapp.com/korona1-min.png";
var virus2 = "https://sajtasdasdas.000webhostapp.com/korona2-min.png";
var virus3 = "https://sajtasdasdas.000webhostapp.com/korona3-min.png";
var virus4 = "https://png.pngtree.com/png-clipart/20190517/original/pngtree-cartoon-virus-shape-body-png-image_3502987.jpg";
...
function dodajVirus(i){
  ...
  //  let object = {'right' : rs};
    $('.virusi').append("<div class='box' id='box"+i+"'></div>");
     ...
     $('#box'+i).css({'background-image': 'url(' + virusi[Math.floor(Math.random() * virusi.length)] + ')'});
...
window.setInterval(function() {
     ...
     $('#box'+i).hide();
     number++;
     document.getElementById("poeni").innerHTML = number;
     if(number === 30){
       virus.pause();
       pobeda.play();
          $(".kraj-igre").show();
